          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="space-y-2" data-testid="usage-sms">
                ...
                <Progress value={Math.min(100, (usage.usage.smsSegments / 500) * 100)} className="h-1.5" />
              ...
              <div className="space-y-2" data-testid="usage-voice">
                ...
                <Progress value={Math.min(100, (usage.usage.voiceMinutes / 100) * 100)} className="h-1.5" />
                <p className="text-xs text-muted-foreground">Metered usage</p>
              </div>
              <div className="space-y-2" data-testid="usage-users">
                ...
                <Progress
                  value={subscription ? Math.min(100, (usage.usage.activeUsers / (subscription.maxUsers === 999 ? usage.usage.activeUsers + 5 : subscription.maxUsers)) * 100) : 0}
                  className="h-1.5"
                />
                <p className="text-xs text-muted-foreground">
                  {subscription ? `of ${subscription.maxUsers === 999 ? "unlimited" : subscription.maxUsers} included` : ""}
                </p>
              </div>
            </div>
          </CardContent>
