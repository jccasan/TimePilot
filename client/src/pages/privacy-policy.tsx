    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <div className="bg-green-700 p-6 text-center rounded-t-lg">
          <h1 className="text-xl font-bold text-white" data-testid="text-privacy-title">
            Privacy Policy
          </h1>
        </div>
        <CardContent className="p-6 prose prose-sm max-w-none text-sm text-muted-foreground space-y-4">
          ...
          <p>
            We collect personal information you voluntarily provide when you use our services,
            request a quote, or communicate with us. This may include your name, email address,
            phone number, mailing address, and service preferences.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Send transactional SMS messages such as appointment reminders, ETA notifications, and
          ...
          <p>
            If you opt in to receive text messages, we may send you recurring automated marketing
            and informational messages at the phone number you provide. Message and data rates may
            apply. Message frequency varies. You can opt out at any time by replying STOP to any
            message. For help, reply HELP or contact us directly.
          </p>
          <p>
            We do not sell, rent, or share your phone number or SMS opt-in consent with third
            parties or affiliates for promotional purposes. Your information is used solely for the
          ...
          <p>
            ...
            service providers who assist us in operating our business (e.g., payment processors, SMS
            providers), subject to confidentiality obligations. We may also disclose information if
            required by law.
          </p>
          ...
          <p>
            ...
            unauthorized access, alteration, or destruction. However, no method of transmission over
