...
import { isAuthenticated, getCompanyContext, requireRole, getBaseUrl, handleError, sanitizeDecimal, auditLog, p, clearRouteOptimizationState, provisionPortalAccess, validateAndResolveAddOns } from "./shared";
