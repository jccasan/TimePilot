...
import { contacts, invoices, routes, reminderLogs, messages as messagesTable, type Message } from "@shared/schema";
...
import { isAuthenticated, getCompanyContext, requireRole, getBaseUrl, handleError, auditLog, p, getStopOnlyOnlyContactIds, provisionPortalAccess, getDemoCompanyId } from "./shared";
