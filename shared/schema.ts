...
export const TIER_CONFIG = {
  ...
  tier_1_3:     { name: "Walk",                 maxUsers: 3,   maxContacts: null as number | null, price: 49,  additionalUserPrice: 7, visible: true,  weeklyOptimizerCredits: 15 },
  tier_3_5:     { name: "Run",                  maxUsers: 6,   maxContacts: null as number | null, price: 99,  additionalUserPrice: 7, visible: true,  weeklyOptimizerCredits: 30 },
  tier_6_10:    { name: "Grow",                 maxUsers: 12,  maxContacts: null as number | null, price: 149, additionalUserPrice: 7, visible: true,  weeklyOptimizerCredits: 60 },
