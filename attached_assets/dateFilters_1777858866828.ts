...
import type { Customer, ExcludedCustomer } from "./types.js";
import { diffDays, isWithinRange, parseIsoDate } from "./dateUtils.js";
...
export function splitRoutableCustomers(customers: Customer[]): SplitResult {
  ...
  return { routableCustomers: routable, excludedCustomers: excluded, needsLocationReview: needsReview };
}
